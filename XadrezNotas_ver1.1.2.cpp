...
void SelectPiece( int vez, bool &RokB1, bool &RokP1, bool &RokB2, bool &RokP2, int &DePassagemL, int &DePassagemC )
{
	...
	***********************************/
	...
	do
	{
		...
		for(int Blc = 6;Blc<67;Blc++)//Checa quais peças estão ameaçadas(14,15,24,25,34,35,44,45,46,47,54,55,56,57,64,65,66,67).
		{
			if (Blc % 2 ==0){ Blc += 8; }
	...
	{
		for(int Blc = 4;Blc<64;Blc++)//Checa quais peças estão ameaçadas(12,13,22,23,32,33,42,43,42,43,52,53,62,63).
		{
			if (Blc % 2 == 0){ Blc += 8; }
