	...
	*/
	...
	do
	{
		...
		if (novame == 3)		
		{
			setlocale(LC_ALL, "Portuguese");
			printf(" _______________________________  \n");
			printf("|  Não pode mover na sua peça ! | \n");
			printf("|   Escolha onde mover a peça   | \n");
			printf("|_______________________________| \n");
			printf("|                               | \n");
			printf("|        MOVIMENTAR PEÇA        | \n");
		...
		if (certezae=='nao' || certezae=='NAO' || certezae=='não' || certezae=='NÃO' || certezae=='Não' || certezae=='Nao' || certezae=='n' || certezae=='N' || certezae=='Nn' || certezae=='nn' || certezae=='NN')
		{
			system("cls");
			PrintBoard();
			normale = 0;
		...
		for(int Blc = 6;Blc<67;Blc++)//Checa quais peças estão ameaçadas
		{
			if (Blc % 2 ==0){ Blc += 8; }

			//Se a casa não estiver vazia, e não for uma casa selecionada para possivel jogada.
