...
void SelectPiece( int vez, bool &RokB1, bool &RokP1, bool &RokB2, bool &RokP2, int &DePassagemL, int &DePassagemC )
{
	...
	*/
	...
	//Nesses if's seleciona a peca e mostra seus possiveis destinos:

		//Checa se foi selecionado um peao branco
		if (Board[8-linha][coluna-1] == 10)
		{
			
			//Checa se o peao branco esta no centro da primeira coluna
			if ((coluna == 1)&&(linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7))
			{
				if (Board[8-linhacima][colunadireita-1] == 11 || Board[8-linhacima][colunadireita-1] == 21 || Board[8-linhacima][colunadireita-1] == 31 || Board[8-linhacima][colunadireita-1] == 41 || Board[8-linhacima][colunadireita-1] == 51 || Board[8-linhacima][colunadireita-1] == 61)
				{
					Board[8-linhacima][colunadireita-1] += 2+vez;
				}
				if (Board[8-linhacima][coluna-1] == 0)
				{
					Board[8-linhacima][coluna-1] += 2+vez;
				}
				if ((Board[8-linhacimadois][coluna-1] == 0)&&(linha == 2))
				{
					Board[8-linhacimadois][coluna-1] += 2+vez;
				}
			}
			
			//Checa se o peao branco esta no centro da oitava coluna
			if ((coluna == 8)&&(linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7))
			{
				if (Board[8-linhacima][colunaesquerda-1] == 11 || Board[8-linhacima][colunaesquerda-1] == 21 || Board[8-linhacima][colunaesquerda-1] == 31 || Board[8-linhacima][colunaesquerda-1] == 41 || Board[8-linhacima][colunaesquerda-1] == 51 || Board[8-linhacima][colunaesquerda-1] == 61)
				{
					Board[8-linhacima][colunaesquerda-1] += 2+vez;
				}
				if (Board[8-linhacima][coluna-1] == 0)
				{
					Board[8-linhacima][coluna-1] += 2+vez;
			...
			//Checa se o peao branco esta no meio do tabuleiro
			if ((linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7)&&(coluna == 2 || coluna == 3 || coluna == 4 || coluna == 5 || coluna == 6 || coluna == 7))
			{
				if (Board[8-linhacima][colunadireita-1] == 11 || Board[8-linhacima][colunadireita-1] == 21 || Board[8-linhacima][colunadireita-1] == 31 || Board[8-linhacima][colunadireita-1] == 41 || Board[8-linhacima][colunadireita-1] == 51 || Board[8-linhacima][colunadireita-1] == 61)
				{
			...
			peca = Board[8-linha][coluna-1];
		}
	
		//Checa se foi selecionado um peao preto
		if (Board[8-linha][coluna-1] == 11)
		{
			
			//Checa se o peao preto esta no centro da primeira coluna
			if ((coluna == 1)&&(linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7))
			{
				if (Board[8-linhabaixo][colunadireita-1] == 10 || Board[8-linhabaixo][colunadireita-1] == 20 || Board[8-linhabaixo][colunadireita-1] == 30 || Board[8-linhabaixo][colunadireita-1] == 40 || Board[8-linhabaixo][colunadireita-1] == 50 || Board[8-linhabaixo][colunadireita-1] == 60)
				{
					Board[8-linhabaixo][colunadireita-1] += 2+vez;
				}
				if (Board[8-linhabaixo][coluna-1] == 0)
				{
					Board[8-linhabaixo][coluna-1] += 2+vez;
				}
			}
			
			//Checa se o peao preto esta no centro da oitava coluna
			if ((coluna == 8)&&(linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7))
			{
				if (Board[8-linhabaixo][colunaesquerda-1] == 10 || Board[8-linhabaixo][colunaesquerda-1] == 20 || Board[8-linhabaixo][colunaesquerda-1] == 30 || Board[8-linhabaixo][colunaesquerda-1] == 40 || Board[8-linhabaixo][colunaesquerda-1] == 50 || Board[8-linhabaixo][colunaesquerda-1] == 60)
				{
					Board[8-linhabaixo][colunaesquerda-1] += 2+vez;
				}
				if (Board[8-linhabaixo][coluna-1] == 0)
				{
					Board[8-linhabaixo][coluna-1] += 2+vez;
			...
			//Checa se o peao preto esta no meio do tabuleiro
			if ((linha == 2 || linha == 3 || linha == 4 || linha == 5 || linha == 6 || linha == 7)&&(coluna == 2 || coluna == 3 || coluna == 4 || coluna == 5 || coluna == 6 || coluna == 7))
			{
				if (Board[8-linhabaixo][colunadireita-1] == 10 || Board[8-linhabaixo][colunadireita-1] == 20 || Board[8-linhabaixo][colunadireita-1] == 30 || Board[8-linhabaixo][colunadireita-1] == 40 || Board[8-linhabaixo][colunadireita-1] == 50 || Board[8-linhabaixo][colunadireita-1] == 60)
				{
			...
			if ((linha == 7)&&(coluna == 1 || coluna == 2 || coluna == 3 || coluna == 4 || coluna == 5 || coluna == 6 || coluna == 7 || coluna == 8))
			{
				if (Board[8-linhabaixodois][coluna-1] == 0)
				{
					Board[8-linhabaixodois][coluna-1] += 2+vez;
				}
			}
	...
	*/
	...
	//Move a pe?a:
	if ((Board[DestLinha][DestColuna] == 2)||(Board[DestLinha][DestColuna] == 3)||(Board[DestLinha][DestColuna] == 12)||(Board[DestLinha][DestColuna] == 22)||(Board[DestLinha][DestColuna] == 32)||(Board[DestLinha][DestColuna] == 42)||(Board[DestLinha][DestColuna] == 52)||(Board[DestLinha][DestColuna] == 62)||(Board[DestLinha][DestColuna] == 13)||(Board[DestLinha][DestColuna] == 23)||(Board[DestLinha][DestColuna] == 33)||(Board[DestLinha][DestColuna] == 43)||(Board[DestLinha][DestColuna] == 53)||(Board[DestLinha][DestColuna] == 63))
	//Se uma casa selecionada:
	{
		Board[DestLinha][DestColuna] = peca;//Aloca a pe?a em seu destino.
		Board[8-linha][coluna-1] = 0;//Retira a pe?a de sua origem.
	}
